...
/** Se utilizó una ventana para desarrolarlo pues ya traía definidos los listeners*/
...
public class client_frame extends javax.swing.JFrame 
{
    ...
    public class IncomingReader implements Runnable
    {
        ...
        public void run() 
        {
            ...
            try 
            {
                while ((stream = reader.readLine()) != null) /**Lee la siguiente línea de caracteres del flujo de entrada estándar.  */
                {
                     data = stream.split(":"); /** "Genere un flujo dúplex (transformación) que divide su flujo en fragmentos controlados" */
...
/** Partes de la ventana: (Barra, botones)*/
...
/**La parte superior de la ventana*/
        ...
        lb_username.setText("Nombre Moxhiitho:");
        ...
        b_disconnect.setText("Bye");
        b_disconnect.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                b_disconnectActionPerformed(evt);
            }
        });
/** Con este botón haremos que se pueda conectar con un nickname por default*/
        b_anonymous.setText("I'm Willy");
        ...
        b_send.setText("Mandar a la buena de Deus");
        b_send.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                b_sendActionPerformed(evt);
            }
        });
/** Nombre de nuestra ventanita  cool*/
        lb_name.setText("PrebeChat");
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                writer.println(username + ":se conectó .:Conectadp");
                writer.flush(); 
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
                ta_chat.append("No conecta! (Intentnado otra vez) \n");
                tf_username.setEditable(true);
            }
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        ...
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                reader = new BufferedReader(streamreader);
                writer = new PrintWriter(sock.getOutputStream());
                writer.println(anon + ":conectó.:Conectado");
                writer.flush(); 
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
                ta_chat.append("No jala :( (Calando otra vez...) \n");
                tf_username.setEditable(true);
            }
    ...
    // Variables declaracion con sus respectivos botones
